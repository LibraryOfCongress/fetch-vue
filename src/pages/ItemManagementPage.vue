<template>
  ...
  >
    ...
    />
    <ItemDisplay
      v-else-if="$route.name == 'item-management-items' && itemDetails.id"
    />
...
// Store Data
const { itemDetails } = storeToRefs(useItemManagementStore())
const { getItemDetails } = useItemManagementStore()
